...
packages = ["mxfold2", "mxfold2.fold", "mxfold2.utils"]

package_data = {"": ["*"], "mxfold2": ["models/*", "src/*", "src/fold/*", "src/param/*"]}
...
entry_points = {"console_scripts": ["mxfold2 = mxfold2.__main__:main"]}
